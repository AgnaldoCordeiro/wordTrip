      ...
      <Box as="main" mx={["4", "4", "12", "140px"]}>
        ...
        >
          ...
          <Info
            ...
            most_visited_cities_number={
              continent.more_information.most_visited_cities_number
            }
          />
        </Grid>
        ...
        <Box as="section" my={{ base: "8", md: "12", lg: "20" }}>
          {continent.more_information.most_visited_cities && (
            <>
              <Text as="h2" fontWeight="medium" fontSize={["2xl", "4xl"]}>
                Cidades +100
              </Text>

              <Citys citys={continent.more_information.most_visited_cities} />
            </>
          )}
        </Box>
      </Box>
